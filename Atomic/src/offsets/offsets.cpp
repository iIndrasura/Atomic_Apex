...
namespace OFFSETS
{
    ...
    const long AMMO_IN_CLIP = 0x1664;                       // [RecvTable.DT_WeaponX_LocalWeaponData] -> m_ammoInClip
    const long AMMO_STOCKPILE = 0x1694;             // [RecvTable.DT_WeaponX_LocalWeaponData] -> m_ammoInStockpile
    const long SEMI_AUTO = 0x1c2c;                     // [Miscellaneous]                        -> CWeaponX!m_isSemiAuto STILL NEED 
